          ...
          <div class="content-wrapper">
            <div class="row justify-content-center">
              ...
              <h3 class="page-title">Edit Kategori</h3>
                ...
                <div class="card">
                  <div class="card-body">
                    <h3 class="card-title mb-5">Form Edit Kategori</h3>
					          <?php if($this->session->flashdata('error')): ?>
						        <div class="alert alert-danger">
							      <?= $this->session->flashdata('error') ?>
						        </div>
					          <?php endif ?>
                    <form class="forms-sample" action="<?= base_url('admin/Kategori/editProcess') ?>" method="POST">
					          <input type="hidden" value="<?= $kategori['id_kategori'] ?>" name="id_kategori">
                    <div class="form-group">
                        <label for="id_kategori">ID Kategori</label>
                        <input type="text" class="form-control" id="id_kategori" name="id_kategori" placeholder="Masukkan ID Kategori" value="<?= $kategori['id_kategori'] ?>" required />
                      </div>  
                      <div class="form-group">
